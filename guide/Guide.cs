...
namespace data
{
    public partial class Guide : global.BaseForm
    {
        ...
        private void EditRemark(GuideEntity entity, DataSetGuide.GuideRow row, int num)
        {
            if (entity.remark.IndexOf("延误") >= 0)
            {
                ...
                else
                {
                    ...
                    {
                        entity.remark = "预计起飞ETD" + entity.etd;
                    }
                    else
                    {
                        entity.remark = row.departoutward + "延误至ETD" + entity.etd;
                    }
                }
            }
