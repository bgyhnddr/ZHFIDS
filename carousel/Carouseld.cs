...
namespace data
{
    public partial class Carouseld : global.BaseForm
    {
        ...
        private void SetValueByRow(DataSetCarousel.CarouselRow row, System.Windows.Forms.Panel panel)
        {
            ...
            titlePanel.Controls.Add(new System.Windows.Forms.PictureBox()
            {
                Name = panel.Name + "picLogo",
                Image = global.Function.GetIcon(row.airlinecode),
                SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom,
                Size = new System.Drawing.Size(logoSize, logoSize),
                Location = new Point(5, (titleSize - logoSize) / 2)
            });

            titlePanel.Controls.Add(new System.Windows.Forms.Label()
            {
                Name = panel.Name + "lbFlight",
                Font = new Font("黑体", titleSize, FontStyle.Bold, System.Drawing.GraphicsUnit.Pixel),
                ForeColor = Color.White,
                AutoSize = true,
                Location = new Point(5 + logoSize, 0),
                Text = row.flight
            });
